...
import "./paybswapToken.sol";

contract bnbBridge is Multiownable {
    BEP20TokenPAYB private token;
    ...
    function withdrawBNBer(uint256 amount, address payable reciever) public onlyAllOwners {
        require(amount > 0,"Amount of tokens should be more then 0");
        require(reciever != address(0), "Zero account");
